...
df_1=pd.read_csv("first_Telecom (maybe).csv")
...
def predict():
    ...
    df_2['tenure'] = pd.to_numeric(df_2['tenure'], errors='coerce').astype(pd.Int32Dtype())
    ...
    new_df__dummies = pd.get_dummies(df_2[['SeniorCitizen', 'gender', 'Partner', 'Dependents', 'PhoneService',
